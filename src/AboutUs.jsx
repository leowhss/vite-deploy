  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">
        Welcome to Warhammer Nursery, where green meets serenity!
      </p>
      <p className="about-us-content">
        At Warhammer Nursery, we are passionate about bringing nature closer to
      ...
      <p className="about-us-content">
        ...
        Warhammer Nursery today and experience the beauty of nature right at
        your doorstep.
      </p>
    </div>
  );
